...
export default class HWlab3Pano extends Component {
    constructor(props) {
        super(props);
        this.state = {
            pano_img: "/images/b1/hwlab3/1.jpg",
            showModal: false,
            status: true,
            page: 1,
            title: "Psss. Did you know?",
            quote: "This is a MDP arena board!"
        };
    }
    ...
    handleHotSpotClick = (number) => {
        this.setState({
            pano_img: "/images/b1/hwlab3/" + number + ".jpg",
            page: number
        });
    };
    handleDetailsClick = () => {
        ...
        switch (this.state.page) {
            case 1:
                ...
                >
                    <Pannellum.Hotspot
                        type="custom"
                        pitch={-5.692015907635136}
                        yaw={-84.520010903511699}
                        text="more details"
                    ...
                    <Pannellum.Hotspot
                        type="custom"
                        pitch={-3.372015907635136}
                        yaw={-152.87896444170997}
